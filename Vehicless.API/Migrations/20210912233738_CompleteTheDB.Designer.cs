...
namespace Vehicless.API.Migrations
{
    ...
    [Migration("20210912233738_CompleteTheDB")]
    partial class CompleteTheDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.Detail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.VehiclePhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Vehicless.API.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.Detail", b =>
                {
                    b.HasOne("Vehicless.API.Data.Entities.History", "History")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.History", b =>
                {
                    b.HasOne("Vehicless.API.Data.Entities.Vehicle", "Vehicle")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("Vehicless.API.Data.Entities.Vehicle", b =>
                {
                    ...
                    b.HasOne("Vehicless.API.Data.Entities.User", "User")
                        .WithMany("Vehicles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
